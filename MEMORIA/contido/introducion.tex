...
\begin{itemize}
    ...
    \item \textbf{Capítulo 4. Desarrollo del proyecto:} Se detallan los requisitos del
    sistema, la metodología seguida, la planificación de tareas y los recursos empleados
    durante el proceso de desarrollo.

    \item \textbf{Capítulo 5. Arquitectura y diseño:} Se expone la arquitectura general del
    sistema distribuido y las fases por las que pasa, la trayectoria base sobre la que se
    apoya, los mensajes que intercambian los nodos y el algoritmo de control.

    \item \textbf{Capítulo 6. Implementación del diseño:} Se describe cómo se construyó cada
    pieza: la concurrencia interna de los nodos, la detección del coche y del paso por meta,
    el algoritmo de velocidad, el sistema hardware, las herramientas de grabación y análisis
    y el despliegue del sistema.

    \item \textbf{Capítulo 7. Pruebas:} Se presentan las pruebas realizadas para verificar
    el funcionamiento del sistema, junto con los resultados obtenidos y su análisis.

    \item \textbf{Capítulo 8. Conclusiones y trabajo futuro:} Se recogen las conclusiones
...
La memoria se completa con cuatro apéndices, que recogen las instrucciones de ejecución del
sistema, el detalle del nodo de captura y del nodo de actuación, y los listados de código y
de configuración a los que se hace referencia a lo largo del texto.
