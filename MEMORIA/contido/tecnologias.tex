...
\texttt{[FUN-\allowbreak FINDCOLOR]}, o \texttt{[ALGO-CTRL]}) que facilita reconstruir la
...
calibración. La parte delantera del coche va guiada por la ranura del carril, mientras que la
trasera no lleva imán y es la que se abre en las curvas al superar la adherencia, que es justo
lo que el sistema interpreta como un derrape. Este entorno físico constituye el escenario sobre
el que interactúan la red de cámaras y el control hardware del sistema.
