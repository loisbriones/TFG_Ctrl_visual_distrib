...
\begin{figure}[tbp]
  ...
  \begin{subfigure}[b]{0.78\textwidth}
    \centering
    \includegraphics[width=\linewidth]{imaxes/PRUEBAS/PWM_INCREMENTAL/escalera_azul.pdf}
    \caption{Coche azul}
  ...
  \begin{subfigure}[b]{0.78\textwidth}
    \centering
    \includegraphics[width=\linewidth]{imaxes/PRUEBAS/PWM_INCREMENTAL/escalera_rojo.pdf}
    \caption{Coche rojo}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.92\textwidth]{imaxes/PRUEBAS/POLITICA_OPTIMA/tiempos_politica.pdf}
  \caption{Tiempo por vuelta de las cuatro ejecuciones. El algoritmo arranca en su tensión mínima y tarda catorce vueltas en alcanzar el ritmo que la política lleva desde la primera; a partir de ahí las cuatro curvas se superponen.}
