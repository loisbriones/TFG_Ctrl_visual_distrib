...
\lettrine{E}{n} este anexo se recogen íntegras las definiciones de los mensajes propios del sistema (sección~\ref{subsec:mensajes-propios}) y los ficheros que definen su configuración y despliegue (sección~\ref{sec:configuracion_despliegue}), junto con la política que se emplea en la prueba de la sección~\ref{sec:prueba-politica-optima}. Los tres listados que se emplean como ejemplo en el cuerpo de la memoria —el mensaje \texttt{CarLocation} y el fichero de lanzamiento y el \emph{compose} del nodo de captura— están en los listados~\ref{lst:msg-carlocation}, \ref{lst:camera-launch} y~\ref{lst:compose-camera}.
