...
\begin{figure}[tbp]
    ...
    \end{subfigure}
    \caption{Obtención del ROI a partir del desplazamiento entre los dos últimos fotogramas (las flechas encadenadas). La cruz es la posición predicha, a 1,6~px de la real, y el último panel es lo único que llega al detector de color}
...
\begin{figure}[tbp]
    ...
    \end{subfigure}
    \caption{Detección de la línea de meta en la cámara~2. Los raíles parten la etiqueta en tres trozos que el cierre morfológico vuelve a unir, y el rectángulo de área mínima que la envuelve da el segmento de meta}
