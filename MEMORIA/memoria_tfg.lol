\contentsline {lstlisting}{\numberline {5.1}{\ignorespaces Definición del mensaje \texttt {CarLocation}}}{34}{lstlisting.5.1}%
\contentsline {lstlisting}{\numberline {A.1}{\ignorespaces Bloque del fichero de parámetros que define los coches}}{82}{lstlisting.A.1}%
\contentsline {lstlisting}{\numberline {A.2}{\ignorespaces Arranque de un nodo de captura}}{83}{lstlisting.A.2}%
\contentsline {lstlisting}{\numberline {A.3}{\ignorespaces Arranque de los nodos de control y del nodo de potencia}}{83}{lstlisting.A.3}%
\contentsline {lstlisting}{\numberline {A.4}{\ignorespaces Arranque en modo manual}}{83}{lstlisting.A.4}%
\contentsline {lstlisting}{\numberline {A.5}{\ignorespaces Arranque del panel en directo}}{83}{lstlisting.A.5}%
\contentsline {lstlisting}{\numberline {D.1}{\ignorespaces Mensajes que transportan la información del sistema}}{91}{lstlisting.D.1}%
\contentsline {lstlisting}{\numberline {D.2}{\ignorespaces Mensajes auxiliares, empleados como piezas de construcción de los anteriores}}{92}{lstlisting.D.2}%
\contentsline {lstlisting}{\numberline {D.3}{\ignorespaces Mensajes del sondeo de red}}{92}{lstlisting.D.3}%
\contentsline {lstlisting}{\numberline {D.4}{\ignorespaces Parámetros de los coches y de las cámaras (\texttt {config/params.yaml})}}{92}{lstlisting.D.4}%
