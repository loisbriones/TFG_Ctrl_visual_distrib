...
"""
    ...
    if logs:
        ...
        partes.append(seccion(
            ...
            "Por la misma razón, una zona de derrape <strong>partida entre dos "
            "cámaras</strong> (una curva que ninguna ve entera, y que el "
            "algoritmo reparte con el mecanismo de derrame) sale con el "
            "<strong>mismo color y la misma forma en las dos</strong>, y la "
            "leyenda lo marca con <code>↔</code>: es un único tramo de pista, "
            "no dos problemas distintos. Cada mitad conserva su rango de celdas "
            "y su PWM, que pueden diferir porque se ajustan por separado. "
